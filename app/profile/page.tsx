...
const Profile: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen transition-colors duration-300 p-6">
      {/* Profile Card */}
      <div className="flex flex-col items-center bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-sm w-full mb-8">
        ...
        <p className="text-base text-gray-600 dark:text-gray-400 mb-2">
          <strong>Minor:</strong> {profile.minor}
        </p>
        <p className="text-base text-gray-600 dark:text-gray-500 mb-2">
          {profile.description}
        </p>
